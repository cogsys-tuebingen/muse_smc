#include <muse_mcl_2d_ndt/models/gridmap_beam_model.h>

#include <muse_mcl_2d_laser/laserscan_2d.hpp>
#include <muse_mcl_2d_ndt/maps/gridmap.h>

#include <class_loader/class_loader_register_macro.h>
CLASS_LOADER_REGISTER_CLASS(muse_mcl_2d_ndt::GridmapBeamModel, muse_mcl_2d::UpdateModel2D)

namespace muse_mcl_2d_ndt {
GridmapBeamModel::GridmapBeamModel()
{
}

void GridmapBeamModel::apply(const data_t::ConstPtr          &data,
...
void GridmapBeamModel::doSetup(ros::NodeHandle &nh)
{
