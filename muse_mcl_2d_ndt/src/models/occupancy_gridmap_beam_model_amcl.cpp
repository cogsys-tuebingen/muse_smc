#include <muse_mcl_2d_ndt/models/occupancy_gridmap_beam_model_amcl.h>

#include <muse_mcl_2d_laser/laserscan_2d.hpp>
#include <muse_mcl_2d_ndt/maps/occupancy_gridmap.h>

#include <class_loader/class_loader_register_macro.h>
CLASS_LOADER_REGISTER_CLASS(muse_mcl_2d_ndt::OccupancyGridmapBeamModelAMCL, muse_mcl_2d::UpdateModel2D)

namespace muse_mcl_2d_ndt {
OccupancyGridmapBeamModelAMCL::OccupancyGridmapBeamModelAMCL()
{
}

void OccupancyGridmapBeamModelAMCL::apply(const data_t::ConstPtr          &data,
...
void OccupancyGridmapBeamModelAMCL::doSetup(ros::NodeHandle &nh)
{
