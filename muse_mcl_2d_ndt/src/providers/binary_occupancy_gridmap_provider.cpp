#include <muse_mcl_2d_ndt/providers/binary_occupancy_gridmap_provider.h>
...
CLASS_LOADER_REGISTER_CLASS(muse_mcl_2d_ndt::BinaryOccupancyGridmapProvider, muse_mcl_2d::MapProvider2D)

namespace muse_mcl_2d_ndt {
BinaryOccupancyGridmapProvider::BinaryOccupancyGridmapProvider() :
    loading_(false)
{
}

BinaryOccupancyGridmapProvider::state_space_t::ConstPtr BinaryOccupancyGridmapProvider::getStateSpace() const
{
    {
...
void BinaryOccupancyGridmapProvider::setup(ros::NodeHandle &nh)
{
...
void BinaryOccupancyGridmapProvider::loadMap()
{
    if (!loading_ && !map_) {
        loading_ = true;
...
void BinaryOccupancyGridmapProvider::publishMap() const
{
    if (!map_)
        return;
