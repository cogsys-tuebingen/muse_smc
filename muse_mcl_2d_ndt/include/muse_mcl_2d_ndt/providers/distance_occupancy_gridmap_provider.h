#ifndef MUSE_MCL_2D_NDT_DISTANCE_OCCUPANCY_GRIDMAP_PROVIDER_H
#define MUSE_MCL_2D_NDT_DISTANCE_OCCUPANCY_GRIDMAP_PROVIDER_H
...
class DistanceOccupancyGridmapProvider : public muse_mcl_2d::MapProvider2D
{
public:
    DistanceOccupancyGridmapProvider();
...
#endif // MUSE_MCL_2D_NDT_DISTANCE_OCCUPANCY_GRIDMAP_PROVIDER_H
