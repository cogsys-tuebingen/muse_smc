...
//    tf::StampedTransform              w_T_primary;
//    tf::StampedTransform              primary_T_o(primary_map->getOrigin().tf(),
//                                                  now,
//                                                  primary_map->getFrame() + "_origin",
//                                                  primary_map->getFrame());
//    std::vector<tf::StampedTransform> secondary_map_transforms;
...
//            math::Pose pose = primary_T_o * rng();
